...
void main()
{
    ...
    gl_Position      = u_Camera.projection * u_Camera.view * u_Transform * vec4(i_Pos, 1.0);
    vs_out.FragPos   = vec3(u_Transform * vec4(i_Pos, 1.0));
    vs_out.Normal    = mat3(transpose(inverse(u_Transform))) * i_Normal;
