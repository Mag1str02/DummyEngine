...
void Logger::IStage(const std::string &log_name, const std::string &massage)
{
    IWrite(log_name, massage, "STAGE");
}
...
void Logger::Stage(const std::string &log_name, const std::string &massage)
{
    Get().IStage(log_name, massage);
}
