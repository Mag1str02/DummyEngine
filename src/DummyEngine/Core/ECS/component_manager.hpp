...
namespace DE
{
    ...
    private:
        ...
        void RegisterComponent()
        {
            ...
            _component_arrays[component_name] =
                std::make_shared<ComponentArray<ComponentType>>(ComponentArray<ComponentType>(_entity_amount));
    ...
    public:
        ...
        std::shared_ptr<ComponentArray<ComponentType>> GetComponentArray()
        {
            ...
            return std::static_pointer_cast<ComponentArray<ComponentType>>(
                _component_arrays[typeid(ComponentType).name()]);
        }
